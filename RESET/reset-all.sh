...
export SLACK_BOOK=".*bookinfo-in-progress.*"
...
then
    oc scale --replicas=1  deployment mysql-deployment -n robot-shop #>/dev/null 2>&1
...
echo ""
echo "--------------------------------------------------------------------------------------------------------------------------------"
echo "Delete Bookinfo NOI Events"
echo "--------------------------------------------------------------------------------------------------------------------------------"
...
delete from alerts.status where AlertGroup='bookinfo';
go
exit
EOF"
echo " ✅ OK"
...
echo ""
echo "--------------------------------------------------------------------------------------------------------------------------------"
echo "Empty Slack Channel $SLACK_BOOK"
echo "--------------------------------------------------------------------------------------------------------------------------------"

  export SLACK_CHANNEL=$SLACK_BOOK
  python3 ./slack-cleaner.py
echo " ✅ OK"
