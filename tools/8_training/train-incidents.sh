...
oc cp ./tools/8_training/3_incidents/test-incidents.json $(oc get po |grep model-train-console|awk '{print $1}'):/home/zeno/data/trainingdata/incident/test-incidents.json
...
printForTrainingPod "bash index_incidents.sh s3://similar-incident-service/test-incidents.json 1000 1000"
