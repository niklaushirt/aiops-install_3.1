...
export DATA_FILE="./tools/8_training/1_events/events_qotd.json"
...
echo "***************************************************************************************************************************************************"
echo ""
echo " 🚀  CP4WAIOPS Event Grouping Training for Quote of the Day"
echo ""
echo "***************************************************************************************************************************************************"
...
echo "Creating Quote of the Day  Events for training"
