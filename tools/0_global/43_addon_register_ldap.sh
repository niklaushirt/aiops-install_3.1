...
header3Begin "Register LDAP Users in Common Services"
        ...
        CS_SERVER_IP=$(ping cp-console.$CLUSTER_NAME -c 1 -q | grep -m1 "("| awk '{print $3}' | ${SED} "s/[(]//" | ${SED} "s/[)]//" | ${SED} "s/[:]//")
        ...
        then
            ...
            cloudctl iam resource-add $TEAM_ID -r crn:v1:icp:private:k8:mycluster:n/$WAIOPS_NAMESPACE:::
            __output "      ✅ OK"
