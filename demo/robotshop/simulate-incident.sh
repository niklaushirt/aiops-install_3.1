...
then
      ...
      echo "Git Push"
      input="./robotshop/events_git.json"
...
then
      ...
      echo "Metrics Push"
      input="./robotshop/events_metrics.json"
      while IFS= read -r line
      do
        export my_timestamp=$(date +%s)000
        echo "Injecting Event at: $my_timestamp"
...
then
      ...
      echo "Falco Push"
      input="./robotshop/events_falco.json"
      while IFS= read -r line
      do
        export my_timestamp=$(date +%s)000
        echo "Injecting Event at: $my_timestamp"
...
then
      ...
      echo "Instana Push"
      input="./robotshop/events_instana.json"
      while IFS= read -r line
      do
        export my_timestamp=$(date +%s)000
        echo "Injecting Event at: $my_timestamp"
...
then
      ...
      input="./robotshop/events_humio.json"
      while IFS= read -r line
      do
        export my_timestamp=$(date +%s)000
        echo "Injecting Event at: $my_timestamp"
    ...
    export LOGS_TOPIC=logs-humio-$appgroupid_robotshop-$appid_robotshop
    ...
    input="./robotshop/log_errors_big.json"
    while IFS= read -r line
    do
      export my_timestamp=$(date +%s)000
