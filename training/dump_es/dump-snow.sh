...
export WORKING_DIR="./training/dump_es/DUMP_LOGS/snow"
...
echo "***************************************************************************************************************************************************"
echo ""
echo " 🚀  CP4WAIOPS Dump SNOW Indexes"
echo ""
echo "***************************************************************************************************************************************************"
...
echo "***************************************************************************************************************************************************"
echo "   🔎  INCIDENTTRAIN indexes"
echo "***************************************************************************************************************************************************"

for index in $(curl -k -u $username:$password -XGET https://localhost:9200/_cat/indices | sort | grep "incidenttrain" | awk '{print $3}'); 
do
  echo "***************************************************************************************************************************************************"
...
for index in $(curl -k -u $username:$password -XGET https://localhost:9200/_cat/indices | sort | grep "snow" | awk '{print $3}'); 
do
  echo "***************************************************************************************************************************************************"
  echo "   💾  Dumping Index ${index}.json"
  elasticdump --input=https://$username:$password@localhost:9200/${index} --limit=5000 --output="$WORKING_DIR/${index}.json" --type=data; 
...
echo "***************************************************************************************************************************************************"
echo ""
echo " ✅  DONE: CP4WAIOPS Dump SNOW Indexes"
echo ""
echo "***************************************************************************************************************************************************"
